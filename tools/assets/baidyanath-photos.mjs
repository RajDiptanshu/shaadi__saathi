...
const PHOTOS = {
  ...
  P06: {
    original: 'c06-mehndi-ring.jpg',
    name: 'mehndi-ring',
    note: 'Mehndi-covered hands folded together, the ring and watch caught in the pattern. Soft studio light already; lifted a touch, not warmed.',
    focal: { x: 0.55, y: 0.45 },
    warmth: 0.02,
    brightness: 1.02,
    saturation: 1.0,
  ...
  P07: {
    original: 'c07-groom-tilak.jpg',
    name: 'groom-tilak',
    note: 'Close portrait with the tilak, looking down. Warm window light already; a small lift keeps it out of shadow on a phone.',
    focal: { x: 0.5, y: 0.4 },
    warmth: 0.02,
    brightness: 1.03,
    saturation: 1.0,
  ...
  P08: {
    original: 'c08-ring-rose.jpg',
    name: 'ring-rose',
    note: 'The ring nestled in a red rose. Already high-contrast and low-key by design; only a small lift so it is not lost on a dim phone screen.',
    focal: { x: 0.55, y: 0.45 },
    warmth: 0.0,
    brightness: 1.02,
    saturation: 1.0,
