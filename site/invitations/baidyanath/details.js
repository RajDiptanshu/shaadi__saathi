/* Baidyanath Dham · Nidhi Keshri and Diptanshu Raj, 24 November 2026, Deoghar.
   Every word the page shows comes from this file. Names, parents, date, time and venue are transcribed
   from the family's printed card. Anything listed in `placeholders` was written here and needs the
   family's eye before this is sent to guests. */
window.INVITE = {
  slug: 'baidyanath',
  ...
  couple: {
    groom: { en: 'Diptanshu', hi: 'दीप्तांशु' },
    bride: { en: 'Nidhi', hi: 'निधि' },
    groomFull: { en: 'Diptanshu Raj', hi: 'दीप्तांशु राज' },
    brideFull: { en: 'Nidhi Keshri', hi: 'निधि केशरी' }
  },
  ...
  hosts: {
    bride: {
      parents: { en: 'Mr. Rajeev & Mrs. Sudha Keshri', hi: 'श्री राजीव एवं श्रीमती सुधा केशरी' },
      invite: {
        en: 'cordially invite you to grace the auspicious wedding ceremony of their beloved daughter',
        hi: 'अपनी प्रिय सुपुत्री के शुभ विवाह समारोह में आपकी गरिमामयी उपस्थिति की सादर कामना करते हैं'
      }
    },
    groom: {
      parents: { en: 'Mr. Suresh & Mrs. Meera Chaudhary', hi: 'श्री सुरेश एवं श्रीमती मीरा चौधरी' },
      relation: { en: 'Beloved son of', hi: 'के प्रिय सुपुत्र' }
    },
    presence: {
  ...
  copy: {
    ...
    noteTitle: { en: 'From Nidhi and Diptanshu', hi: 'निधि और दीप्तांशु की ओर से' },
    note: {
  ...
  ui: {
    openInvite: 'Open the invitation from Nidhi and Diptanshu',
