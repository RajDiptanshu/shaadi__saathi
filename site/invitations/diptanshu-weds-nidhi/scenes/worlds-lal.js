    ...
    layers: [
         ...
         goes and the corners fall away. */
      {
        depth: 0, build: function (g, defs, c) {
          g.appendChild(c.el('rect', {
            ...
            fill: c.gradient([[0, '#1E0309'], [0.28, '#420915'], [0.56, '#67142B'], [0.80, '#4E0B1B'], [1, '#22040C']])
          }));
          g.appendChild(c.el('ellipse', {
            cx: 500, cy: 620, rx: 640, ry: 540,
            fill: c.radial([[0, '#A31A35', 0.66], [0.52, '#761225', 0.30], [1, '#761225', 0]])
          }));
        }
      },
         ...
         layer, they separate as the page scrolls — which is what makes the silk look folded. */
      {
        depth: 0.14, build: function (g, defs, c) {
          var lit = c.radial([[0, '#C12C24', 0.40], [0.55, '#A31A35', 0.18], [1, '#A31A35', 0]]);
      ...
      },
      {
        depth: 0.28, build: function (g, defs, c) {
          var lit = c.radial([[0, '#AD2238', 0.34], [0.55, '#801326', 0.16], [1, '#801326', 0]]);
    ...
    layers: [
      {
        depth: 0, build: function (g, defs, c) {
          g.appendChild(c.el('rect', {
            x: -60, y: -60, width: c.VBW + 120, height: c.VBH + 120,
            fill: c.gradient([[0, '#22040C'], [0.42, '#4E0B1B'], [0.74, '#5B1124'], [1, '#2A0511']])
          }));
          g.appendChild(c.el('ellipse', {
            cx: 500, cy: 720, rx: 600, ry: 500,
            fill: c.radial([[0, '#94162E', 0.56], [1, '#94162E', 0]])
          }));
        }
      },
    ...
    layers: [
      {
        depth: 0, build: function (g, defs, c) {
          ...
          g.appendChild(c.el('ellipse', {
            ...
            fill: c.radial([[0, '#94162E', 0.48], [1, '#94162E', 0]])
          }));
        }
      },
    ...
    layers: [
      {
        depth: 0, build: function (g, defs, c) {
          g.appendChild(c.el('rect', {
            x: -60, y: -60, width: c.VBW + 120, height: c.VBH + 120,
            fill: c.gradient([[0, '#1C0309'], [0.34, '#4A0A18'], [0.66, '#5B1124'], [1, '#22040C']], 118)
          }));
        }
      },
         ...
         to breathe. Without it the scene is a flat wall. */
      {
        depth: 0.12, build: function (g, defs, c) {
          var r = c.rng(5);
          var pale = c.radial([[0, '#A31A35', 0.62], [0.55, '#801326', 0.28], [1, '#801326', 0]]);
